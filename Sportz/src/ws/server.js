...
function handleMessage(socket, data){
   ...
   try{
     ...
     sendMessage(socket , {error : 'Invalid JSON'})
   }
...
export function attachWebsocketServer(server){
    ...
    wss.on('connection' , (socket) => {
        ...
        sendMessage(socket , {message :  "Welcome to the Sportz Websocket Server"})
    ...
    function broadcastComment(matchId , comment){
        broadcastMatch(matchId , {type : 'commentary' , data : comment})
    }
    return {broadcast, broadcastComment}
}